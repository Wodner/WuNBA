...
//                    Logger.d("=====视频信息 ：" + resp);
     ...
     * @param requestCallBack
     */
    public static void getNBAGameLiveDataInfo(String mid, final RequestCallBack<String> requestCallBack){
        RequestParams params = new RequestParams(NBAApi.getNBAGameLiveDataInfo(mid));
        x.http().get(params, new Callback.CommonCallback<String>() {
            @Override
            public void onSuccess(String result) {
                if (result != null && !TextUtils.isEmpty(result)) {
