...
//public class SeasonDataFragment extends BaseFragment implements NBADataSortAdapter.OnRecyclerViewItemClickListener{
//
...
//    public static SeasonDataFragment seasonDataFragment;
//    private NBADataSortAdapter nbaDataAdapter;
//    private int currentTypeIndex = 0;
//    private String[] TextStatType= {"得分","篮板","助攻","盖帽","抢断"};
//    private final String UrlTabType = NBAApi.NBA_DATA_TABTYPE_SEASON;
...
//    private ModelNBADataBlock block;
//
//
//    public static SeasonDataFragment getInstance(){
//        if(seasonDataFragment == null){
//            seasonDataFragment = new SeasonDataFragment();
//        }
//        return seasonDataFragment;
//    }
//
//    @Nullable
//    @Override
...
//        block = new ModelNBADataBlock();
//        steal = new ModelNBADataSteal();
//        nbaDataAdapter = new NBADataSortAdapter(mContext);
...
//            ballLaodingShow(0);
//            getNBAData(NBAApi.getNBAPDataSort(UrlTabType,UrlStatType[currentTypeIndex],"2016"));
//        }else{
...
//                break;
//            case 3:
//                ModelNBADataBlock block= gson.fromJson(result,ModelNBADataBlock.class);
