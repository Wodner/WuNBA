...
public class VideoTidbitsFragment extends BaseFragment implements NBAVideoView {
    ...
    public static VideoTidbitsFragment videoTidbitsFragment;

    public static VideoTidbitsFragment getInstance(){
        if(videoTidbitsFragment == null){
            videoTidbitsFragment = new VideoTidbitsFragment();
        }
        return videoTidbitsFragment;
    }
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        nbaVideoPresenter.initialized(NBAVideoPresenter.TYPE_VIDEO_TIDBITS);
    }
    ...
    private void initXRecyclerView() {
        ...
        mRecyclerView.setOnRefreshListener(new OnRefreshListener() {
            ...
            public void onRefresh() {
                ...
                nbaVideoPresenter.setArticleIds(VIDEO_PAGER_NUM,NBAVideoPresenter.TYPE_VIDEO_TIDBITS);
            }
        });
