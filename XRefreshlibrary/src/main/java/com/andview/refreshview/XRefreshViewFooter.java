...
//    private View mProgressBar;
    private ImageView ivBallLoading;
    ...
    public void onStateReady() {
        ...
        ivBallLoading.setVisibility(View.GONE);
        mClickView.setText(R.string.xrefreshview_footer_hint_click);
...
//        show(true);
    ...
    public void onStateRefreshing() {
        mHintView.setVisibility(View.GONE);
        ivBallLoading.setVisibility(View.VISIBLE);
...
//        setVisibility(show?VISIBLE:GONE);
    ...
    private void initView(Context context) {
        ...
        ivBallLoading = (ImageView) moreView
                .findViewById(R.id.iv_ball_loading);
